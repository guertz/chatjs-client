...
APP=src/app/app.o src/common/base64/base64.o src/common/helpers/helpers.o src/common/logger/logger.o src/common/web-ui/web-ui.o src/directives/modals/auth-modal/auth-modal.o src/directives/modals/chat-modal/chat-modal.o src/directives/modals/connectivity/connectivity.o src/directives/modals/modals.o src/directives/navbar/navbar.o src/directives/navbar/profile/profile.o src/directives/toast/toast.o src/main.o src/pages/chat-details/chat-details.o src/pages/chat-list/chat-list.o src/protocol/sockets/definitions/request.o src/protocol/sockets/definitions/response.o src/protocol/sockets/easywsclient.o src/protocol/sockets/wscustom.o src/providers/chats/chats.o src/states/auth-state/auth-state.o src/states/auth-state/definitions/auth.o src/states/auth-state/definitions/user.o
