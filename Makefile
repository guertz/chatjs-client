...
APP=src/app/app.o src/common/base64/base64.o src/common/logger/logger.o src/common/web-ui/web-ui.o src/components/chat-details/chat-details.o src/components/chat-list/chat-list.o src/components/modals/auth-modal/auth-modal.o src/components/modals/chat-modal/chat-modal.o src/components/modals/connectivity/connectivity.o src/components/modals/modals.o src/components/navbar/navbar.o src/components/navbar/profile/profile.o src/components/toast/toast.o src/main.o src/models/chat/chat.o src/models/chat/message.o src/models/json-item.o src/models/socket/auth/auth.o src/models/socket/chat/chat.o src/models/socket/chats/chats.o src/models/socket/socket.o src/models/socket/users/users.o src/models/user/user.o src/protocol/sockets/easywsclient.o src/protocol/sockets/wscustom.o src/states/auth-state/auth-state.o src/states/chat-state/chat-state.o src/states/users-state/users-state.o
